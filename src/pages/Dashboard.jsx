...
import SidebarIcon from '../images/sidebar-button.png'; // Make sure the path is correct
import searchIcon from '../images/search-icon.png'; // Make sure the path is correct
import filterIcon from '../images/filter-icon.png'; // Make sure the path is correct
import notificationIcon from '../images/notification-icon.png'; // Make sure the path is correct
import moreButtonIcon from '../images/more-button.png'; // Ensure the path is correct
